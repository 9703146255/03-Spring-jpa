...
public interface EmpRepository extends CrudRepository<Employee, Integer>
{
	...
	//==========================
	//retrive records based on non-primary key column than we can use findByXXXX() METHOD
	...
	List<Employee>	readByEmpSalaryBetween(Double startSal, Double endSal);
	
	List<Employee> readByOrderByEmpSalary();
