...
public class EmployeeService {
	...
	public void readBySalBetween(Double startSal,Double endSal)
	{
		List<Employee> readByEmpSalaryBetween = empRepository.readByEmpSalaryBetween(startSal, endSal);
		readByEmpSalaryBetween.forEach(s->System.out.println(s));
		
	}
	
	
	public void readByOrderByEmpSal()
	{
		List<Employee> readByOrderByEmpSalary = empRepository.readByOrderByEmpSalary();
		readByOrderByEmpSalary.forEach(s->System.out.println(s));
	}
